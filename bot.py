...
async def select_province(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("Добавить еще" if lang == "ru" else "Add More", callback_data="add_province"),
         InlineKeyboardButton("Посмотреть результат" if lang == "ru" else "View Result", callback_data="view_result")],
        [InlineKeyboardButton("Меню" if lang == "ru" else "Menu", callback_data="back_to_main_menu")]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
...
async def view_result(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("Добавить провинцию" if lang == "ru" else "Add More", callback_data="add_province"),
         InlineKeyboardButton("Меню" if lang == "ru" else "Menu", callback_data="back_to_main_menu")]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
